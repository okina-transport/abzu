...
import App from './App';
import MobilityPoints from './MobilityPoints'; // ✅ Nouveau composant unifié
    ...
    render() {
        ...
        const routes = (
            <Route path={path} component={App}>
                <IndexRoute component={MobilityPoints} />
                <Route path={path + Routes.STOP_PLACE + '(/:stopId)'} component={MobilityPoints} />
                <Route path={path + Routes.PARKING + '(/:parkingId)'} component={MobilityPoints} />
                <Route path={path + Routes.POINT_OF_INTEREST + '(/:pointOfInterestId)'} component={MobilityPoints} />
                <Route path={path + Routes.GROUP_OF_STOP_PLACE + '/:groupId'} component={MobilityPoints} />
