...
class ImportTADPage extends Component{
    ...
    handleOnSubmit(e){
        ...
        if(this.state.file !== ""){
            ...
            this.fileReader.onload = (event) => {
                ...
                const url = tiamatBaseUrl + "tad/tad_import_csv";
            ...
            <div>
                ...
                <ReportFilterBox style={{width: '60%'}}>
                    ...
                    <RaisedButton
                        ...
                        label={formatMessage({id: 'upload_tad_file_submit'})}
                        onClick={(event) => {
...
export default withApollo(connect(mapStateToProps)(injectIntl(ImportTADPage)));
