  ...
  switch (action.type) {
    ...
    case types.RESTORED_TO_ORIGINAL_STOP_PLACE:
      return Object.assign({}, state, {
        ...
        pathLink: state.originalPathLink !== undefined ? JSON.parse(JSON.stringify(state.originalPathLink)) : [],
      });
    ...
    case types.NAVIGATE_TO:
      if (action.payLoad === '' || action.payLoad.includes('PointOfInterest') || action.payLoad.includes('Parking')) {
        return Object.assign({}, state, {
          pathLink: [],
          current: null,
          newStop: null
