...
import {extractAlternativeNames, getImportedId, getImportedName, simplifyPlaceEquipment} from './stopPlaceUtils';
  ...
  toClient() {
    ...
    try {
      ...
      if (stop.keyValues) {
        ...
        clientStop.importedName = getImportedName(stop.keyValues);
