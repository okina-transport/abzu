...
export const findStopForReport = gql`
    query findStopForReport($query: String, $nearbyRadius: Int,$importedId: String, $municipalityReference: [String], $stopPlaceType: [StopPlaceType], $countyReference: [String], $countryReference: [String], $withoutLocationOnly: Boolean!, $withDuplicateImportedIds: Boolean!,$nearbyStopPlaces: Boolean!, $detectMultiModalPoints: Boolean!, $pointInTime: DateTime, $withNearbySimilarDuplicates: Boolean, $hasParking: Boolean, $tags: [String], $withTags: Boolean, $code: String, $versionValidity: VersionValidity) {
        stopPlace(query: $query,nearbyRadius:$nearbyRadius , importedId: $importedId, municipalityReference: $municipalityReference, stopPlaceType: $stopPlaceType, countyReference: $countyReference, countryReference: $countryReference, withoutLocationOnly: $withoutLocationOnly, withDuplicatedQuayImportedIds: $withDuplicateImportedIds,nearbyStopPlaces: $nearbyStopPlaces, detectMultiModalPoints: $detectMultiModalPoints, pointInTime: $pointInTime, size: 300, withNearbySimilarDuplicates: $withNearbySimilarDuplicates, hasParking:$hasParking, tags: $tags, withTags: $withTags, code: $code, versionValidity: $versionValidity) {
            ...on StopPlace {
                ...ReportStopPlace
            }
            ...on ParentStopPlace {
