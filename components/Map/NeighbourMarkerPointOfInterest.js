...
class NeighbourMarkerPointOfInterest extends React.Component {
    ...
    render() {
        ...
        return (
            <Marker
                key={'neighbour-pointOfInterest' + id}
                keyboard={false}
                icon={icon}
                position={position}
                draggable={false}
            >
                <Popup
                    onOpen={() => {
                        this.setState({
                            isAllowedToCreateFrom: isLegalChildStopPlace(pointOfInterest, tokenParsed)
                        })
                    }}
                    autoPan={false}
                >
...
export default NeighbourMarkerPointOfInterest;
