...
import AudibleSignalsAvailable from '../../static/icons/accessibility/AudibleSignalsAvailable';
import IconButton from 'material-ui/IconButton';
import accessibilityAssessments from '../../models/accessibilityAssessments';

class AudibleSignalsAvailablePopover extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  render() {
    const { intl, displayLabel, audibleSignalsAvailable, disabled } = this.props;
    const { locale } = intl;
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <AudibleSignalsAvailable
              color={accessibilityAssessments.colors[audibleSignalsAvailable]}
            />
          </IconButton>
          {displayLabel
        ...
        >
          {accessibilityAssessments.AudibleSignalsAvailable.options.map(
            (option, index) =>
              <MenuItem
                key={'AudibleSignalsAvailableItem' + index}
                value={option}
...
export default AudibleSignalsAvailablePopover;
